...
export const SCENE_3_ASSETS = {
  ...
  morningGardenScorched: "/images/backgrounds/scene-3-morning-garden-scorched.png",
...
export const LATER_STORY_ASSETS = {
  ...
  bathroomShadow: "/images/backgrounds/chapter-3-mirror-shadow-black.png",
  ...
  familyEvening: "/images/backgrounds/chapter-2-family-evening.png",
  snailOffering: "/images/backgrounds/chapter-3-snail-offering.png",
  snailShadow: "/images/backgrounds/chapter-3-snail-shadow.png",
  thumbPayment: "/images/backgrounds/chapter-3-thumb-payment.png",
  emptyDogBed: "/images/backgrounds/chapter-4-empty-dog-bed.png",
  familyThreat: "/images/backgrounds/chapter-4-family-threat.png",
  finalSpell: "/images/backgrounds/chapter-5-final-spell.png",
  serpentPov: "/images/backgrounds/chapter-5-serpent-pov.png",
  breakfastLetter: "/images/backgrounds/chapter-5-breakfast-letter.png",
} as const;

/**
 * 최종 14분 서사의 인과관계용 마스터 타임라인입니다. 렌더 영상, 자막, 사운드는
 * 이 절대 시간을 기준으로 맞춥니다. Chapter 1은 202초이며 이후 완성된 MP4 경계를 따릅니다.
 */
export const FULL_STORY_TIMING = {
  chapter1Start: 0,
  ritualSpell: 171.25,
  familyEveningStart: 202,
  familyEveningEnd: 216,
  morningStart: 216,
  handleBreak: 240,
  firstPowerReactionEnd: 254,
  schoolConfidenceStart: 254,
  schoolShadowStart: 266,
  carPowerStart: 272,
  carPowerEnd: 290,
  flowerScorchStart: 298,
  flowerScorchEnd: 304,
  sleeplessNightsStart: 308,
  mirrorStart: 316,
  mirrorRevealStart: 325,
  chapter2End: 336,
  contractNightStart: 336,
  contractVoiceStart: 362,
  offeringStart: 388,
  soulTransferStart: 402,
  paymentStart: 416,
  largerDemandStart: 438,
  refusalStart: 482,
  chapter3End: 504,
  dogAbsenceStart: 504,
  lossRevealStart: 518,
  contractBreakStart: 547,
  familyThreatStart: 568,
  warStart: 604,
  voidStart: 620,
  chapter4End: 672,
  finalBattleStart: 672,
  finalSpellStart: 710,
  shadowGoneStart: 734,
  serpentApproachStart: 760,
  wakeStart: 790,
  breakfastStart: 807,
  letterReturnStart: 821,
  finalLookStart: 835,
  end: 840,
} as const;
...
/** 실제 편집본의 시작 프레임과 일치하는 공연자용 5개 챕터입니다. */
export const FIVE_CHAPTER_MARKERS: SceneMarker[] = [
  { id: "chapter-1-invitation", label: "I · THE INVITATION", timeSeconds: 0 },
  { id: "chapter-2-first-sign", label: "II · THE FIRST SIGN", timeSeconds: 202 },
  { id: "chapter-3-bargain", label: "III · THE BARGAIN", timeSeconds: 336 },
...
export const PLAYER_CONFIG: PlayerConfig = {
  ...
  durationSeconds: FULL_STORY_TIMING.end,
  videoSource: "/video/performance-film.mp4",
  animationAudioSource: "/audio/test-scene-soundtrack.mp3",
  chapterMotionClips: [
    {
      id: "chapter-2-first-sign-recut",
      label: "II · THE FIRST SIGN — event recut",
      source: "/video/chapter-2/the-first-sign-recut.mp4",
      startSeconds: FULL_STORY_TIMING.familyEveningStart,
      endSeconds: FULL_STORY_TIMING.chapter2End,
    },
    {
      id: "chapter-3-contract-recut",
      label: "III · THE BARGAIN — contract recut",
      source: "/video/chapter-3/the-contract-recut.mp4",
      startSeconds: 336,
      endSeconds: 504,
    },
    {
      id: "chapter-4-price-recut",
      label: "IV · THE PRICE — consequence recut",
      source: "/video/chapter-4/the-price-recut.mp4",
      startSeconds: 504,
      endSeconds: 672,
    },
    {
      id: "chapter-5-return-recut",
      label: "V · THE RETURN — finale recut",
      source: "/video/chapter-5/the-return-recut.mp4",
      startSeconds: 672,
      endSeconds: FULL_STORY_TIMING.end,
    },
  ],
  ...
  timeline: [
    ...
    {
      id: "first-sign-school",
      label: "달라진 등굣길",
      startSeconds: SCENE_3_TIMING.schoolStart,
      endSeconds: SCENE_3_TIMING.schoolEnd,
      backgroundImage: LATER_STORY_ASSETS.schoolWalk,
      textureImage: "/images/textures/film-grain.svg",
      cameraMotion: { scaleFrom: 1.015, scaleTo: 1.06, xFrom: 0.2, xTo: -0.55, yFrom: 0.1, yTo: -0.15, blurFrom: 0.8, blurTo: 0 },
      transitionType: "dissolve",
    ...
    },
    {
      id: "first-sign-car",
      label: "들려 올라가는 자동차",
      startSeconds: SCENE_3_TIMING.carStart,
      endSeconds: SCENE_3_TIMING.carEnd,
      backgroundImage: LATER_STORY_ASSETS.roadGrounded,
      textureImage: "/images/textures/film-grain.svg",
      cameraMotion: { scaleFrom: 1.01, scaleTo: 1.055, xFrom: 0.2, xTo: -0.4, yFrom: 0, yTo: -0.1, blurFrom: 0.5, blurTo: 0 },
      transitionType: "dissolve",
      transitionDuration: 1.2,
      textPosition: "none",
      textStyle: subtitleStyle,
    ...
    {
      id: "first-sign-garden-consequence",
      label: "그을린 꽃",
      startSeconds: SCENE_3_TIMING.gardenConsequenceStart,
      endSeconds: SCENE_3_TIMING.end,
      backgroundImage: SCENE_3_ASSETS.morningGardenScorched,
      textureImage: "/images/textures/film-grain.svg",
      cameraMotion: { scaleFrom: 1.02, scaleTo: 1.08, xFrom: 0.1, xTo: -0.5, yFrom: 0, yTo: -0.2, blurFrom: 0.9, blurTo: 0.1 },
      transitionType: "rack-focus",
      transitionDuration: 2.2,
      textPosition: "none",
      textStyle: subtitleStyle,
  ...
  textCues: [
    ...
    },
    {
      id: "contract-gift",
      group: "dialogue",
      text: "I will give you the dark in return.",
      startSeconds: 374,
      endSeconds: 381,
    },
    {
      id: "contract-too-small",
      group: "dialogue",
      text: "This body is too small.",
      startSeconds: 471,
      endSeconds: 476,
    },
    {
      id: "contract-larger",
      group: "dialogue",
      text: "Bring me something larger.",
      startSeconds: 482,
      endSeconds: 488,
    },
    {
      id: "boy-refuses-sacrifice",
      group: "dialogue",
      text: "No.",
      startSeconds: 495,
      endSeconds: 499,
    ...
    {
      id: "shadow-punishment",
      group: "dialogue",
      text: "You left me hungry.",
      startSeconds: 528,
      endSeconds: 534,
    },
    {
      id: "boy-ends-contract",
      group: "dialogue",
      text: "The contract is over.",
      startSeconds: 551,
      endSeconds: 557,
      emphasis: true,
    },
    {
      id: "shadow-family-threat",
      group: "dialogue",
      text: "Then they will pay.",
      startSeconds: 581,
      endSeconds: 587,
    },
    {
      id: "boy-protects-family",
      group: "dialogue",
    ...
    },
    {
      id: "breakfast-dream",
      group: "dialogue",
      text: "I had the strangest dream.",
      startSeconds: 813,
      endSeconds: 818,
    },
  ],
  audioCues: [
    {
      id: "chapter-1-exterior-wind",
      source: "/audio/chapter-1/exterior-wind.mp3",
      startSeconds: 0,
      endSeconds: 24,
      gain: 0.46,
      fadeInSeconds: 3,
    ...
    {
      id: "chapter-1-interior-room",
      source: "/audio/chapter-1/interior-room.mp3",
      startSeconds: 12,
      endSeconds: 84,
      gain: 0.28,
      fadeInSeconds: 6,
    ...
    {
      id: "chapter-1-letter-whoosh",
      source: "/audio/chapter-1/letter-whoosh.mp3",
      startSeconds: 24,
      endSeconds: 34,
      gain: 0.72,
      fadeInSeconds: 0.35,
    ...
    {
      id: "chapter-1-paper-close",
      source: "/audio/chapter-1/paper-close.mp3",
      startSeconds: 34,
      endSeconds: 52,
      gain: 0.52,
      fadeInSeconds: 0.35,
    ...
    {
      id: "chapter-1-letter-taps",
      source: "/audio/chapter-1/letter-taps.mp3",
      startSeconds: 52,
      endSeconds: 72,
      gain: 0.46,
      fadeInSeconds: 0.2,
    ...
    {
      id: "chapter-1-time-shift",
      source: "/audio/chapter-1/time-shift.mp3",
      startSeconds: 78,
      endSeconds: 112,
      gain: 0.34,
      fadeInSeconds: 4,
    ...
    {
      id: "chapter-1-ritual-air",
      source: "/audio/chapter-1/ritual-air.mp3",
      startSeconds: 106,
      endSeconds: SCENE_2_TIMING.responseStart,
      gain: 0.3,
      fadeInSeconds: 5,
      fadeOutSeconds: 5,
    },
    {
      id: "chapter-1-threshold-drone",
      source: "/audio/chapter-1/threshold-drone.mp3",
    ...
    {
      id: "chapter-2-domestic-room",
      source: "/audio/chapter-2/domestic-room.mp3",
      startSeconds: FULL_STORY_TIMING.familyEveningStart,
      endSeconds: FULL_STORY_TIMING.firstPowerReactionEnd,
      gain: 0.24,
      fadeInSeconds: 3,
      fadeOutSeconds: 4,
    },
    {
      id: "chapter-2-handle-metal",
      source: "/audio/chapter-2/handle-metal.mp3",
      startSeconds: 235,
      endSeconds: 245,
      gain: 0.58,
      fadeInSeconds: 0.4,
    ...
    {
      id: "chapter-2-morning-street",
      source: "/audio/chapter-2/morning-street.mp3",
      startSeconds: 250,
      endSeconds: FULL_STORY_TIMING.mirrorStart,
      gain: 0.3,
      fadeInSeconds: 4,
      fadeOutSeconds: 5,
    },
    {
      id: "chapter-2-night-rain",
      source: "/audio/chapter-2/night-rain.mp3",
      startSeconds: 304,
      endSeconds: 324,
      gain: 0.24,
      fadeInSeconds: 4,
    ...
    {
      id: "chapter-2-bathroom-hum",
      source: "/audio/chapter-2/bathroom-hum.mp3",
      startSeconds: 312,
      endSeconds: FULL_STORY_TIMING.chapter2End,
      gain: 0.28,
      fadeInSeconds: 4,
    ...
    {
      id: "chapter-3-contract-night",
      source: "/audio/chapter-3/contract-night.mp3",
      startSeconds: FULL_STORY_TIMING.contractNightStart,
      endSeconds: FULL_STORY_TIMING.chapter3End,
      gain: 0.22,
      fadeInSeconds: 5,
      fadeOutSeconds: 4,
    },
    {
      ...
      startSeconds: FULL_STORY_TIMING.contractVoiceStart,
      endSeconds: FULL_STORY_TIMING.offeringStart,
      gain: 0.48,
      fadeInSeconds: 0.8,
      fadeOutSeconds: 2.5,
    },
    {
      id: "chapter-3-offering-air",
      source: "/audio/chapter-3/offering-air.mp3",
      startSeconds: 384,
      endSeconds: FULL_STORY_TIMING.chapter3End,
      gain: 0.24,
      fadeInSeconds: 5,
    ...
    {
      id: "chapter-4-consequence-room",
      source: "/audio/chapter-4/consequence-room.mp3",
      startSeconds: FULL_STORY_TIMING.chapter3End,
      endSeconds: FULL_STORY_TIMING.chapter4End,
      gain: 0.22,
      fadeInSeconds: 4,
      fadeOutSeconds: 4,
    },
    {
      id: "chapter-4-loss-rumble",
      source: "/audio/chapter-4/loss-rumble.mp3",
      startSeconds: 520,
      endSeconds: FULL_STORY_TIMING.familyThreatStart,
      gain: 0.26,
      fadeInSeconds: 7,
      fadeOutSeconds: 5,
    },
    {
      id: "chapter-4-family-shadow",
      source: "/audio/chapter-4/family-shadow.mp3",
      startSeconds: 564,
      endSeconds: FULL_STORY_TIMING.chapter4End,
      gain: 0.23,
      fadeInSeconds: 6,
    ...
    },
    {
      ...
      startSeconds: FULL_STORY_TIMING.chapter4End,
      endSeconds: LATER_STORY_TIMING.mortalEdgeEnd,
      gain: 0.24,
      fadeInSeconds: 7,
      fadeOutSeconds: 4,
    ...
    {
      id: "chapter-5-final-spell-surge",
      source: "/audio/chapter-5/final-spell-surge.mp3",
      startSeconds: FULL_STORY_TIMING.finalSpellStart,
      endSeconds: 724,
      gain: 0.42,
      fadeInSeconds: 1.5,
      fadeOutSeconds: 2.5,
    ...
    {
      id: "chapter-5-serpent-floor",
      source: "/audio/chapter-5/serpent-floor.mp3",
      startSeconds: 756,
      endSeconds: FULL_STORY_TIMING.wakeStart,
      gain: 0.32,
      fadeInSeconds: 4,
      fadeOutSeconds: 1.5,
    },
    ...
    {
      id: "chapter-5-letter-slide",
      source: "/audio/chapter-5/letter-slide.mp3",
      startSeconds: FULL_STORY_TIMING.letterReturnStart,
      endSeconds: 832,
      gain: 0.48,
      fadeInSeconds: 0.3,
      fadeOutSeconds: 1.5,
