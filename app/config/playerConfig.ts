...
export const LATER_STORY_ASSETS = {
  ...
  bathroomShadow: "/images/backgrounds/chapter-3-mirror-shadow-human.png",
 ...
 * 이 절대 시간을 기준으로 맞춥니다. 각 챕터의 시작은 168초 간격으로 유지합니다.
 */
...
export const PLAYER_CONFIG: PlayerConfig = {
  ...
  audioCues: [
    ...
    },
    {
      ...
      startSeconds: FULL_STORY_TIMING.mirrorStart,
      endSeconds: FULL_STORY_TIMING.chapter2End,
      gain: 0.2,
      fadeInSeconds: 2.8,
      fadeOutSeconds: 3.2,
